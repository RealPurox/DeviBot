...
public class HypixelCommand extends ICommand {

    private Devi devi;

    public HypixelCommand(Devi devi) {
        super("hypixel", "hypixelstats", "hypixelplayer");
        this.devi = devi;
    }
    ...
    public void execute(CommandSender sender, Command command) {
        ...
        String search = String.join(" ", command.getArgs());
