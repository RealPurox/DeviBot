...
public class AutoModRolesHandler {
    ...
    public void handle(CommandSender sender, ICommand.Command command) {
        WaitingResponse addRole = new WaitingResponseBuilder(devi, command)
                ...
                .withCustomCheck((response) -> {
                    ...
                    Role role = DiscordUtils.getRole(input, command.getGuild());
                ...
                .withCustomVoid((object) -> {
                    ...
                    Document document = new Document()
                            .append("guild", command.getGuild().getId())
    ...
    private void sendRoles(ICommand.Command command, CommandSender sender) {
