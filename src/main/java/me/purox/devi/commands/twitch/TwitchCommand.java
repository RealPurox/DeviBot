...
public class TwitchCommand extends ICommand {
    ...
    public TwitchCommand(Devi devi) {
        super("twitch");
        this.devi = devi;
    }
    ...
    public void execute(CommandSender sender, Command command) {{
        TextChannel textChannel = DiscordUtils.getTextChannel(command.getDeviGuild().getSettings().getStringValue(GuildSettings.Settings.TWITCH_CHANNEL), command.getGuild());
        ...
        WaitingResponse addStreamer = new WaitingResponseBuilder(devi, command)
                ...
                .withCustomVoid(object -> {
                    ...
                    if (updateResult.wasAcknowledged()) {
                        ...
                        TextChannel channel = DiscordUtils.getTextChannel(command.getDeviGuild().getSettings().getStringValue(GuildSettings.Settings.TWITCH_CHANNEL), command.getGuild());
                        if (channel == null)
